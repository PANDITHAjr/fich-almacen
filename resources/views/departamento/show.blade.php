                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p style="color: #1a237e" class="secondary-text-color">{{$departamento->nombre_depa}}</p>
                            </div>
                    </div>
                    <div class="card-action right-align">
                        <a href="{{ route('departamento.index') }}" class="waves-effect waves-brown btn-flat red-text bold">Atras</a>
                    </div>
                </div>
            </div>
        </div>
